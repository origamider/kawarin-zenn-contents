...
topics: [Zenn, 記事, zenncli, vscode, tech]
published: true
---
## はじめに
...
# 投稿方法
投稿する際、ファイルの一番上にある、publishedをtrueにしてください。以下の通りです。
![](/images/article-1/image4.png)

完成したらあとはpushするだけです。
```
git branch -M main # masterだったらmainにリネーム
git add . # ステージング
...
# 最後に
意外と簡単にできました。ここら辺はたくさんネットに記事が上がっているので、それを参考に、ぜひCliベースで記事を作ってみてください。
